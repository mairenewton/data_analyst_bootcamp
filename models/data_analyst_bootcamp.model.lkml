...
view: product {
  derived_table: {
    sql:  select "1" as product_id,  "Back Truck" as product_name,  "Medium" as product_category,  1238 as product_hourly_price union all
      ...
      select "5" as product_id,  "Dragline" as product_name,  "Light" as product_category,  1633 as product_hourly_priceunion all
      ...
      select "8" as product_id,  "Grader" as product_name,  "Heavy" as product_category,  1325 as product_hourly_priceunion all
...
view: salesperson_staging {
  derived_table: {
    sql: select "1" as salesperson_id,  "Jaime" as salesperson_first_name,  "Elcocks" as salesperson_last_name,  "Senior" as salesperson_level,  38 as salesperson_age,  "Closer" as salespersion_function,  "4" as office_id union all
      ...
      select "32" as salesperson_id,  "Joseito" as salesperson_first_name,  "Drife" as salesperson_last_name,  "Junior" as salesperson_level,  36 as salesperson_age,  "Closer" as salespersion_function,  "3" as office_idunion all
      ...
      select "57" as salesperson_id,  "Phylis" as salesperson_first_name,  "Kun" as salesperson_last_name,  "Junior" as salesperson_level,  24 as salesperson_age,  "Indirect" as salespersion_function,  "1" as office_idunion all
      ...
      select "62" as salesperson_id,  "Melesa" as salesperson_first_name,  "Voisey" as salesperson_last_name,  "Junior" as salesperson_level,  31 as salesperson_age,  "Indirect" as salespersion_function,  "7" as office_idunion all
      ...
      select "65" as salesperson_id,  "Eada" as salesperson_first_name,  "Branford" as salesperson_last_name,  "Junior" as salesperson_level,  37 as salesperson_age,  "Indirect" as salespersion_function,  "5" as office_idunion all
      ...
      select "71" as salesperson_id,  "Grethel" as salesperson_first_name,  "Creigan" as salesperson_last_name,  "Junior" as salesperson_level,  38 as salesperson_age,  "Lead" as salespersion_function,  "3" as office_idunion all
      ...
      select "74" as salesperson_id,  "Wynn" as salesperson_first_name,  "Ellse" as salesperson_last_name,  "Junior" as salesperson_level,  33 as salesperson_age,  "Executer" as salespersion_function,  "4" as office_idunion all
      ...
      select "79" as salesperson_id,  "Alina" as salesperson_first_name,  "Tilmouth" as salesperson_last_name,  "Junior" as salesperson_level,  27 as salesperson_age,  "Lead" as salespersion_function,  "6" as office_idunion all
...
view: customer {
  derived_table: {
    sql:  select "1" as customer_id,  "Trashly" as customer_company_name,  "Long Haul" as customer_type union all
      ...
      select "10" as customer_id,  "Mudcab" as customer_company_name,  "Long Haul" as customer_typeunion all
      ...
      select "13" as customer_id,  "Shover" as customer_company_name,  "Long Haul" as customer_typeunion all
...
view: sales {
  derived_table: {
    sql: select "1" as transaction_id,  date("2020-06-06") as date,  "6" as product_id,  "65" as salesperson_id,  "17" as customer_id,  "6" as office_id,  5 as hours,  9740 as sales,  "Florida" as transaction_state union all
      ...
      select "24" as transaction_id,  date("2020-01-13") as date,  "6" as product_id,  "39" as salesperson_id,  "19" as customer_id,  "2" as office_id,  43 as hours,  83764 as sales,  "Maryland" as transaction_stateunion all
      ...
      select "31" as transaction_id,  date("2020-11-19") as date,  "9" as product_id,  "34" as salesperson_id,  "12" as customer_id,  "7" as office_id,  33 as hours,  62502 as sales,  "Florida" as transaction_stateunion all
      ...
      select "35" as transaction_id,  date("2021-10-15") as date,  "4" as product_id,  "26" as salesperson_id,  "8" as customer_id,  "8" as office_id,  44 as hours,  76340 as sales,  "Arizona" as transaction_stateunion all
      ...
      select "50" as transaction_id,  date("2021-05-26") as date,  "8" as product_id,  "33" as salesperson_id,  "15" as customer_id,  "6" as office_id,  28 as hours,  37100 as sales,  "Pennsylvania" as transaction_stateunion all
      ...
      select "52" as transaction_id,  date("2020-07-12") as date,  "4" as product_id,  "94" as salesperson_id,  "10" as customer_id,  "4" as office_id,  25 as hours,  43375 as sales,  "Colorado" as transaction_stateunion all
      ...
      select "54" as transaction_id,  date("2021-06-25") as date,  "1" as product_id,  "5" as salesperson_id,  "16" as customer_id,  "3" as office_id,  39 as hours,  48282 as sales,  "Ohio" as transaction_stateunion all
      ...
      select "74" as transaction_id,  date("2020-02-08") as date,  "5" as product_id,  "65" as salesperson_id,  "7" as customer_id,  "9" as office_id,  47 as hours,  76751 as sales,  "Alabama" as transaction_stateunion all
      ...
      select "79" as transaction_id,  date("2020-02-12") as date,  "4" as product_id,  "6" as salesperson_id,  "5" as customer_id,  "2" as office_id,  92 as hours,  159620 as sales,  "Virginia" as transaction_stateunion all
      ...
      select "90" as transaction_id,  date("2021-03-27") as date,  "2" as product_id,  "92" as salesperson_id,  "13" as customer_id,  "10" as office_id,  73 as hours,  115559 as sales,  "Utah" as transaction_stateunion all
      ...
      select "97" as transaction_id,  date("2021-05-30") as date,  "5" as product_id,  "42" as salesperson_id,  "1" as customer_id,  "4" as office_id,  45 as hours,  73485 as sales,  "Florida" as transaction_stateunion all
      ...
      select "112" as transaction_id,  date("2021-03-21") as date,  "9" as product_id,  "73" as salesperson_id,  "13" as customer_id,  "10" as office_id,  10 as hours,  18940 as sales,  "Colorado" as transaction_stateunion all
      ...
      select "120" as transaction_id,  date("2021-04-30") as date,  "2" as product_id,  "6" as salesperson_id,  "3" as customer_id,  "8" as office_id,  65 as hours,  102895 as sales,  "Ohio" as transaction_stateunion all
      ...
      select "132" as transaction_id,  date("2020-01-05") as date,  "10" as product_id,  "26" as salesperson_id,  "18" as customer_id,  "6" as office_id,  5 as hours,  7530 as sales,  "New York" as transaction_stateunion all
      ...
      select "141" as transaction_id,  date("2021-10-23") as date,  "9" as product_id,  "88" as salesperson_id,  "18" as customer_id,  "8" as office_id,  98 as hours,  185612 as sales,  "Utah" as transaction_stateunion all
      ...
      select "161" as transaction_id,  date("2021-08-17") as date,  "4" as product_id,  "19" as salesperson_id,  "5" as customer_id,  "2" as office_id,  76 as hours,  131860 as sales,  "Maryland" as transaction_stateunion all
      ...
      select "167" as transaction_id,  date("2020-10-17") as date,  "1" as product_id,  "59" as salesperson_id,  "15" as customer_id,  "8" as office_id,  74 as hours,  91612 as sales,  "Missouri" as transaction_stateunion all
      ...
      select "169" as transaction_id,  date("2021-09-26") as date,  "4" as product_id,  "53" as salesperson_id,  "1" as customer_id,  "4" as office_id,  84 as hours,  145740 as sales,  "Texas" as transaction_stateunion all
      ...
      select "238" as transaction_id,  date("2020-04-19") as date,  "10" as product_id,  "87" as salesperson_id,  "3" as customer_id,  "7" as office_id,  76 as hours,  114456 as sales,  "Illinois" as transaction_stateunion all
      ...
      --select "248" as transaction_id,  date("2021-02-24") as date,  "6" as product_id,  "63" as salesperson_id,  "4" as customer_id,  "2" as office_id,  40 as hours,  77920 as sales,  "Florida" as transaction_stateunion all
      ...
      select "271" as transaction_id,  date("2021-03-27") as date,  "5" as product_id,  "66" as salesperson_id,  "5" as customer_id,  "8" as office_id,  96 as hours,  156768 as sales,  "Georgia" as transaction_stateunion all
      ...
      select "276" as transaction_id,  date("2021-06-13") as date,  "5" as product_id,  "25" as salesperson_id,  "20" as customer_id,  "6" as office_id,  96 as hours,  156768 as sales,  "Ohio" as transaction_stateunion all
      ...
      select "279" as transaction_id,  date("2021-06-02") as date,  "11" as product_id,  "79" as salesperson_id,  "20" as customer_id,  "8" as office_id,  24 as hours,  29208 as sales,  "Florida" as transaction_stateunion all
      ...
      select "289" as transaction_id,  date("2021-06-02") as date,  "11" as product_id,  "52" as salesperson_id,  "17" as customer_id,  "5" as office_id,  79 as hours,  96143 as sales,  "Iowa" as transaction_stateunion all
      ...
      select "293" as transaction_id,  date("2021-06-01") as date,  "8" as product_id,  "71" as salesperson_id,  "12" as customer_id,  "4" as office_id,  98 as hours,  129850 as sales,  "Texas" as transaction_stateunion all
      ...
      select "300" as transaction_id,  date("2021-05-27") as date,  "2" as product_id,  "57" as salesperson_id,  "18" as customer_id,  "4" as office_id,  60 as hours,  94980 as sales,  "Arizona" as transaction_stateunion all
      ...
      select "311" as transaction_id,  date("2021-01-25") as date,  "8" as product_id,  "29" as salesperson_id,  "9" as customer_id,  "9" as office_id,  8 as hours,  10600 as sales,  "Ohio" as transaction_stateunion all
      ...
      select "329" as transaction_id,  date("2021-04-28") as date,  "3" as product_id,  "74" as salesperson_id,  "15" as customer_id,  "2" as office_id,  37 as hours,  70448 as sales,  "Texas" as transaction_stateunion all
      ...
      --select "347" as transaction_id,  date("2021-01-06") as date,  "11" as product_id,  "21" as salesperson_id,  "1" as customer_id,  "9" as office_id,  40 as hours,  48680 as sales,  "Virginia" as transaction_stateunion all
      ...
      select "353" as transaction_id,  date("2020-07-27") as date,  "7" as product_id,  "6" as salesperson_id,  "3" as customer_id,  "2" as office_id,  1 as hours,  1979 as sales,  "Tennessee" as transaction_stateunion all
      ...
      select "367" as transaction_id,  date("2021-08-15") as date,  "3" as product_id,  "81" as salesperson_id,  "7" as customer_id,  "4" as office_id,  89 as hours,  169456 as sales,  "Texas" as transaction_stateunion all
      ...
      select "387" as transaction_id,  date("2020-03-06") as date,  "7" as product_id,  "39" as salesperson_id,  "8" as customer_id,  "8" as office_id,  29 as hours,  57391 as sales,  "Texas" as transaction_stateunion all
      ...
      select "390" as transaction_id,  date("2021-04-09") as date,  "4" as product_id,  "52" as salesperson_id,  "18" as customer_id,  "4" as office_id,  84 as hours,  145740 as sales,  "Nebraska" as transaction_stateunion all
      ...
      select "392" as transaction_id,  date("2021-09-19") as date,  "3" as product_id,  "80" as salesperson_id,  "3" as customer_id,  "7" as office_id,  5 as hours,  9520 as sales,  "New York" as transaction_stateunion all
...
view: inventory {
  derived_table: {
    sql: select "1" as inventory_id,  "2" as product_id,  "Held" as status,  94 as condition,  "1" as office_id /* union all
      ...
      select "7" as inventory_id,  "7" as product_id,  "Held" as status,  40 as condition,  "1" as office_idunion all
      ...
      select "12" as inventory_id,  "11" as product_id,  "Open" as status,  46 as condition,  "2" as office_idunion all
      select "13" as inventory_id,  "3" as product_id,  "Held" as status,  20 as condition,  "5" as office_id,  union all
      select "14" as inventory_id,  "4" as product_id,  "Held" as status,  11 as condition,  "5" as office_idunion all
      ...
      select "19" as inventory_id,  "6" as product_id,  "Held" as status,  26 as condition,  "7" as office_idunion all
      ...
      select "25" as inventory_id,  "6" as product_id,  "Held" as status,  69 as condition,  "7" as office_idunion all
      ...
      select "29" as inventory_id,  "2" as product_id,  "Held" as status,  84 as condition,  "10" as office_idunion all
      select "30" as inventory_id,  "8" as product_id,  "Held" as status,  26 as condition,  "8" as office_id,  union all
      select "31" as inventory_id,  "11" as product_id,  "Held" as status,  80 as condition,  "8" as office_idunion all
      select "32" as inventory_id,  "2" as product_id,  "Held" as status,  8 as condition,  "9" as office_id,  union all
      select "33" as inventory_id,  "6" as product_id,  "Held" as status,  52 as condition,  "6" as office_idunion all
      ...
      select "44" as inventory_id,  "1" as product_id,  "Open" as status,  24 as condition,  "8" as office_idunion all
      ...
      select "48" as inventory_id,  "3" as product_id,  "Open" as status,  73 as condition,  "7" as office_idunion all
      select "49" as inventory_id,  "2" as product_id,  "Open" as status,  2 as condition,  "3" as office_id,  union all
      select "50" as inventory_id,  "9" as product_id,  "Open" as status,  18 as condition,  "1" as office_idunion all
      ...
      select "59" as inventory_id,  "2" as product_id,  "Held" as status,  55 as condition,  "9" as office_idunion all
      ...
      select "63" as inventory_id,  "10" as product_id,  "Open" as status,  42 as condition,  "2" as office_idunion all
      select "64" as inventory_id,  "2" as product_id,  "Open" as status,  75 as condition,  "4" as office_id,  union all
      select "65" as inventory_id,  "8" as product_id,  "Held" as status,  20 as condition,  "9" as office_idunion all
      ...
      select "72" as inventory_id,  "7" as product_id,  "Held" as status,  86 as condition,  "6" as office_idunion all
      ...
      select "75" as inventory_id,  "6" as product_id,  "Held" as status,  0 as condition,  "9" as office_idunion all
      ...
      select "79" as inventory_id,  "5" as product_id,  "Held" as status,  92 as condition,  "7" as office_idunion all
      ...
      select "83" as inventory_id,  "7" as product_id,  "Open" as status,  45 as condition,  "6" as office_idunion all
      ...
      select "91" as inventory_id,  "3" as product_id,  "Held" as status,  95 as condition,  "4" as office_idunion all
      ...
      select "96" as inventory_id,  "6" as product_id,  "Held" as status,  18 as condition,  "7" as office_idunion all
      ...
      select "109" as inventory_id,  "7" as product_id,  "Open" as status,  17 as condition,  "5" as office_idunion all
      ...
      select "117" as inventory_id,  "10" as product_id,  "Open" as status,  79 as condition,  "9" as office_idunion all
      ...
      select "121" as inventory_id,  "9" as product_id,  "Open" as status,  3 as condition,  "2" as office_idunion all
      ...
      select "124" as inventory_id,  "3" as product_id,  "Open" as status,  84 as condition,  "2" as office_idunion all
      ...
      select "132" as inventory_id,  "10" as product_id,  "Open" as status,  35 as condition,  "9" as office_idunion all
      select "133" as inventory_id,  "3" as product_id,  "Held" as status,  64 as condition,  "6" as office_id,  union all
      select "134" as inventory_id,  "6" as product_id,  "Open" as status,  65 as condition,  "9" as office_idunion all
      ...
      select "139" as inventory_id,  "11" as product_id,  "Open" as status,  58 as condition,  "4" as office_idunion all
      select "140" as inventory_id,  "1" as product_id,  "Open" as status,  40 as condition,  "6" as office_id,  union all
      select "141" as inventory_id,  "3" as product_id,  "Open" as status,  69 as condition,  "4" as office_idunion all
      ...
      select "147" as inventory_id,  "9" as product_id,  "Open" as status,  68 as condition,  "5" as office_idunion all
      ...
      select "150" as inventory_id,  "6" as product_id,  "Held" as status,  67 as condition,  "9" as office_idunion all
      ...
      select "154" as inventory_id,  "6" as product_id,  "Held" as status,  82 as condition,  "3" as office_idunion all
      ...
      select "162" as inventory_id,  "4" as product_id,  "Open" as status,  70 as condition,  "5" as office_idunion all
      ...
      select "165" as inventory_id,  "11" as product_id,  "Open" as status,  26 as condition,  "3" as office_idunion all
      select "166" as inventory_id,  "1" as product_id,  "Held" as status,  47 as condition,  "1" as office_id,  union all
      select "167" as inventory_id,  "9" as product_id,  "Held" as status,  87 as condition,  "1" as office_idunion all
      ...
      select "173" as inventory_id,  "3" as product_id,  "Open" as status,  36 as condition,  "2" as office_idunion all
      ...
      select "177" as inventory_id,  "7" as product_id,  "Open" as status,  22 as condition,  "10" as office_idunion all
      ...
      select "181" as inventory_id,  "1" as product_id,  "Open" as status,  94 as condition,  "1" as office_idunion all
      ...
      select "185" as inventory_id,  "3" as product_id,  "Open" as status,  33 as condition,  "9" as office_idunion all
      ...
      select "193" as inventory_id,  "1" as product_id,  "Held" as status,  85 as condition,  "2" as office_idunion all
      ...
      select "196" as inventory_id,  "7" as product_id,  "Held" as status,  55 as condition,  "6" as office_idunion all
      ...
      select "199" as inventory_id,  "2" as product_id,  "Open" as status,  93 as condition,  "8" as office_idunion all
