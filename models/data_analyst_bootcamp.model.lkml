...
view: sales {
  derived_table: {
    sql: select "1" as transaction_id,  date("2020-06-06") as date,  "6" as product_id,  "65" as salesperson_id,  "17" as customer_id,  "6" as office_id,  5 as hours,  9740 as sales,  "Florida" as transaction_state union all
      ...
      select "104" as transaction_id,  date("2021-09-22") as date,  "9" as product_id,  "29" as salesperson_id,  "5" as customer_id,  "5" as office_id,  77 as hours,  145838 as sales,  "Florida" as transaction_stte union all
